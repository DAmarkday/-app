...
public class LoginSignUpChangeButton extends View {
    ...
    public LoginSignUpChangeButton(Context context) {
        super(context);
        init();
    }

    public LoginSignUpChangeButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LoginSignUpChangeButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public LoginSignUpChangeButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        signUpPaint.setAlpha(255);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        loginPaint.getTextBounds(getString(R.string.sign_up), 0, 1, r);

        currentLoginX = dpToPixels(92);
        int signUpWidth = r.right;
        currentSignUpTextX = width - signUpWidth / 2 - dpToPixels(32);

        loginPaint.getTextBounds(getString(R.string.login), 0, 1, r);

        loginTextOutline = new Rect();
        signUpTextOutline = new Rect();
        signUpPaint.getTextBounds(getString(R.string.login), 0, 1, loginTextOutline);
        signUpPaint.getTextBounds(getString(R.string.sign_up), 0, 1, signUpTextOutline);
